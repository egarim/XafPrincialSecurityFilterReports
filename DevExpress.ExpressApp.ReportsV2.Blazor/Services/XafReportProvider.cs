...
namespace DevExpress.ExpressApp.ReportsV2.Blazor {
	public class XafReportProvider : IReportProvider {
		private readonly ReportStorageWebExtension reportStorageWebExtension;
		public XafReportProvider(ReportStorageWebExtension reportStorageWebExtension) {
		...
		public XtraReport GetReport(string id, ReportProviderContext context) {
			...
			if(report == null)
				return null;
			((XtraReports.Native.IReportStorageTool2)reportStorageWebExtension).AfterGetData(id, report);
			return report;
		}
	}
}
