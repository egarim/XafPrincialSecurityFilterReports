...
namespace DevExpress.ExpressApp.ReportsV2.Blazor {
	...
	public sealed class ReportViewerContainerDataHolder {
		public ReportViewerContainer Container { get; set; }
		public INewReportWizardParameters NewReportParameters { get; set; }
	}
}
