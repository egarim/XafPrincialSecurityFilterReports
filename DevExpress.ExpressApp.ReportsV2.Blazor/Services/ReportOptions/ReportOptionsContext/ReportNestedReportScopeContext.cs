...
namespace DevExpress.ExpressApp.ReportsV2.Blazor {
	...
	public class ReportNestedReportScopeContext {
		public ReportNestedReportScopeContext(XtraReport report, IServiceProvider parentServiceProvider, IServiceProvider nestedServiceProvider) {
			Report = report;
			ParentServiceProvider = parentServiceProvider;
			NestedServiceProvider = nestedServiceProvider;
		}
		public XtraReport Report { get; }
		public IServiceProvider ParentServiceProvider { get; }
		public IServiceProvider NestedServiceProvider { get; }
	}
}
#nullable restore
